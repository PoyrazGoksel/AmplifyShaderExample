...
namespace PaintIn3D
{
	...
	public class P3dModifyRadiusRandom : P3dModifier
	{
		...
		{
			min = EditorGUILayout.FloatField(new GUIContent("Min", "This is the minimum random radius that will be picked."), min);
			max = EditorGUILayout.FloatField(new GUIContent("Max", "This is the maximum random radius that will be picked."), max);
