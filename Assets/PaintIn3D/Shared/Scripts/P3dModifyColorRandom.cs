...
namespace PaintIn3D
{
	...
	public class P3dModifyColorRandom : P3dModifier
	{
		...
		{
			gradient = EditorGUILayout.GradientField(new GUIContent("Gradient", "This is the gradient containing all the possible colors. A color will be randomly picked from this."), Gradient);
